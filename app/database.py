...
print("Database User:", os.getenv("DDBB_USER"))
print("Database Password:", os.getenv("DDBB_PASSWORD"))
print("Database Host:", os.getenv("DDBB_HOST"))
print("Database Port:", os.getenv("DDBB_PORT"))
print("Database Name:", os.getenv("DDBB_DATABASE"))
